...
import Model.Repo as Repo exposing (Repo)
...
{-| It makes a get request to an url
-}
getRepositories : Cmd Msg
getRepositories =
    Http.get
        { url = "https://api.github.com/users/ardeleanraluca/repos"
    ...
    case msg of
        ...
        GotRepos res ->
            case res of
                ...
                Ok repo_list ->
                    ( { model | repos = repo_list }, Cmd.none )
...
view model =
    ...
    div [ align "center" ]
        ...
        , h1 [ style "background-color" "LightSkyBlue" ] [ text "Experience" ]
        , eventCategoriesView
        , eventsView
        , h1 [ style "background-color" "LightSkyBlue" ] [ text "My top repos" ]
        , reposView
        ]
